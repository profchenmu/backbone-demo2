define([
    ...
    return Marionette.CompositeView.extend({
        ...
        onShow: function(){
            var self = this;
            this.ui.searchForm.vendor/bootstrapValidator({
                message: '',
                feedbackIcons: {
            ...
            .on('keyup', '[name="name"], [name="phone"]', function(e) {
                ...
                var phone = self.ui.searchForm.find('[name="phone"]').val(),
                    ...
                    bv = self.ui.searchForm.data('vendor/bootstrapValidator');
        ...
        _reset2: function(){
            this.ui.searchForm.data('vendor/bootstrapValidator').resetForm();
        },
